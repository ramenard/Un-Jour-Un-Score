    ...
    <div className="nes-theme min-h-screen">
      <div className="pt-42 flex justify-center">
        <div id="questionMarkDiv">
          {result}
          {!result && <QuestionMark/>}
          {result === RockPaperScissorsEnum.ROCK && <img width="100" height="100" className="to-white-png" src="/rock.png" alt="rock"/>}
          {result === RockPaperScissorsEnum.PAPER && <img width="100" height="100" className="to-white-png" src="/paper.png" alt="paper"/>}
          {result === RockPaperScissorsEnum.SCISSORS && <img width="100" height="100" className="to-white-png" src="/scissors.png" alt="scissors"/>}
        </div>
      </div>
      ...
      <Dialog open={isFailed} onOpenChange={(open) => !open && resetData()}>
        <DialogContent className="sm:max-w-md nes-theme">
          <DialogHeader>
            <DialogTitle>Partie Terminée</DialogTitle>
            <DialogDescription>Votre score: {total}</DialogDescription>
          </DialogHeader>
